...
import de.ancash.libs.org.simpleyaml.configuration.comments.format.CommentFormatterConfiguration;
import de.ancash.libs.org.simpleyaml.configuration.comments.format.YamlCommentFormatterConfiguration;
...
public class SnakeYamlCommentMapper extends YamlCommentMapper {
    ...
    protected void setCommentPrefix(final YamlConfigurationOptions options) {
        final CommentFormatterConfiguration sideFormatterConfiguration = options.commentFormatter()
                .formatterConfiguration(de.ancash.libs.org.simpleyaml.configuration.comments.CommentType.SIDE);
    ...
    protected void trackBlockComment(final KeyTree.Node node, final List<CommentLine> comments) {
        if (node != null && comments != null && !comments.isEmpty()) {
            ...
            if (blockComment != null) {
                ...
                this.setRawComment(node, blockComment, de.ancash.libs.org.simpleyaml.configuration.comments.CommentType.BLOCK);
            }
        }
    }
    ...
    protected void trackSideComment(final KeyTree.Node node, final List<CommentLine> comments) {
        if (node != null && comments != null && !comments.isEmpty()) {
            ...
            if (sideComment != null) {
                this.setRawComment(node, sideComment, de.ancash.libs.org.simpleyaml.configuration.comments.CommentType.SIDE);
            }
        }
    }
